// Vercel Serverless Function: List Contract Users
export default async function handler(req, res) {
  ...
  try {
    const endpoint = `${API_BASE_URL}/publisher/licensing/contractUser/list`;
    ...
    // Format response for easier display
    const formatted = {
      total: data.total || 0,
      count: data.count || 0,
      users: data.ContractUserList || [],
      raw: data
    };
